...
GtkTreeModel *init_model(void) {
  ...
  p1 = gdk_pixbuf_new_from_file("/a/1.png", &err); 
  p2 = gdk_pixbuf_new_from_file("/a/2.png", &err);
  p3 = gdk_pixbuf_new_from_file("/a/3.png", &err);
  p4 = gdk_pixbuf_new_from_file("/a/4.png", &err);
